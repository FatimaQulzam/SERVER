...
#                                                                                    #
# https://github.com/FatimaQulzam/SERVER/blob/master/LICENSE #
#                                                                                    #
# This script is not associated with the official Pterodactyl Project.               #
# https://github.com/FatimaQulzam/SERVER                     #
#                                                                                    #
######################################################################################
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/FatimaQulzam/SERVER"}
...
welcome() {
  ...
  output "https://github.com/FatimaQulzam/SERVER"
  output ""
